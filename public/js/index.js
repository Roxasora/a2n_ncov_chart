...
(function() {
  var allRegionCurrentAreaTreeData, allRegionTrendData, confirmedLabelBgColor, confirmedLineColor, csvJSON, curedLabelBgColor, curedLineColor, deadLabelBgColor, deadLineColor, firstChart, getURLParamWithKey, isPhone, jumpToPage, labelConfig, mainChinaData, reload, reloadSecondChart, reloadSelect, reloadTabData, requestAllRegionCurrentAreaTreeData, requestMainChinaData, requestNewsData, requestallRegionTrendData, safeRegion, secondChart, selectedPageIndex, selectedRegion, seriousLabelBgColor, seriousLineColor, startLoading, stopLoading, suspectedLabelBgColor, suspectedLineColor, timeStrWithUnix;
  ...
  jQuery(document).ready(function() {
    var cookieRegion, urlPage, width;
    ...
    if (urlPage && parseInt(urlPage) <= 2 && parseInt(urlPage) >= 0) {
      ...
      return window.history.pushState(null, null, '?p=1');
    } else {
      return jumpToPage(0);
    }
  });
