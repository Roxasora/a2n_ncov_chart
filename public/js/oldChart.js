...
(function() {
  ...
  reload = function() {
    var M, confirmData, curedData, currentDate, dataOffset, date, deadData, i, isMainChina, isSars, item, legendData, mainChinaItem, myChart, nConData, option, seriousData, suspectedData, xAxisData, _i, _ref;
    myChart = echarts.init(document.getElementById("main"), 'dark');
